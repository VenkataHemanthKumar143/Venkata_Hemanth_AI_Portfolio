...
export function Presentation() {
  ...
  const profile = {
    name: 'Venkata Hemanth Kumar Chejarla',
    age: '22 years old',
    location: 'Narasaraopet, Andhra Pradesh',
    // Add a newline character after the emoji
    description:
      "Hey 👋\nI'm Venkata Hemanth Kumar, a passionate Developer and AI enthusiast working at Avaada Electro. I specialize in Python, AI, Machine Learning, and Full-Stack Development. I love building intelligent applications and automating complex processes.",
    src: '/my_Image.jpg',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI', 'Python', 'Full-Stack Developer', 'Data Science'].map(
              (tag) => (
                <span
                  key={tag}
